            ...
            <div className='flex flex-col gap-4 m-5'>
                ...
                <div className='flex-1 border border-stone-100 rounded-lg px-8 py-7 bg-white'>
                    ...
                    <div className='flex gap-2 py-2'>
                        <p>Address:</p>
                        <p className='text-sm'>
                            {isEdit? <input type="text" onChange={(e)=>setProfileData(prev=>({...prev,address:{...prev.adddress,line1:e.target.value}}))} value={profileData.adddress.line1}/>:profileData.address.line1}
                            <br />
                            {isEdit? <input type="text" onChange={(e)=>setProfileData(prev=>({...prev,address:{...prev.adddress,line2:e.target.value}}))} value={profileData.adddress.line2}/>:profileData.address.line2}
                        </p>
                    </div>
